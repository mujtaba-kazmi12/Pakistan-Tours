...
import SignleReviewforType from '../Components/SingleReviewforType'
import AddReviewFormForType from '../Components/AddReviewFormForType'
...
<SignleReviewforType toggleModal={toggleModal} docId={docId}/>

</div>

{isOpen && (<div className="fixed inset-0 bg-black bg-opacity-50 z-40 flex justify-center items-center">
<AddReviewFormForType toggleModal={toggleModal} docId={docId}/>
</div>)}
